...
{                                                                   
    ...
    public boolean equalKeys( OrderedDictionary <K,V> dictionary){
        ...
        Iterator<Entry<K,V>> secondIt = dictionary.iterator();
        K nextKeyInIt;
        K nextKeyInSecondIt;
        while(it.hasNext() && secondIt.hasNext()){
            nextKeyInIt = it.next().getKey();
            nextKeyInSecondIt = secondIt.next().getKey();
            flag=nextKeyInIt.equals(nextKeyInSecondIt);
            if(flag==false)
                return false;
        }
